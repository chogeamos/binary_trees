 ...
 *
 * @root: A pointer to the root node of the tree from which a node will be removed.
 * @value: The value to be removed from the tree.
 *
 * Return: A pointer to the new root node of the tree after removing the specified value.
 */
 ...
 *
 * Return: A pointer to the root node after removal.
 */
...
/**
 * inorder_successor - Returns the minimum value in a binary search tree.
 *
